...
const imageUrls = [
  /*G1*/ 'image_part_043.png',
  /*G2*/ 'image_part_044.png',
  /*G3*/ 'image_part_045.png',
  /*G4*/ 'image_part_046.png',
  /*G5*/ 'image_part_047.png',
  /*G6*/ 'image_part_048.png',
  /*G7*/ 'image_part_049.png',

  /*F1*/ 'image_part_036.png',
  /*F2*/ 'image_part_037.png',
  /*F3*/ 'image_part_038.png',
  /*F4*/ 'image_part_039.png',
  /*F5*/ 'image_part_040.png',
  /*F6*/ 'image_part_041.png',
  /*F7*/ 'image_part_042.png',

  /*E1*/ 'image_part_029.png',
  /*E2*/ 'image_part_030.png',
  /*E3*/ 'image_part_031.png',
  /*E4*/ 'image_part_032.png',
  /*E5*/ 'image_part_033.png',
  /*E6*/ 'image_part_034.png',
  /*E7*/ 'image_part_035.png',

  /*D1*/ 'image_part_022.png',
  /*D2*/ 'image_part_023.png',
  /*D3*/ 'image_part_024.png',
  /*D4*/ 'image_part_025.png',
  /*D5*/ 'image_part_026.png',
  /*D6*/ 'image_part_027.png',
  /*D7*/ 'image_part_028.png',

  /*C1*/ 'image_part_015.png',
  /*C2*/ 'image_part_016.png',
  /*C3*/ 'image_part_017.png',
  /*C4*/ 'image_part_018.png',
  /*C5*/ 'image_part_019.png',
  /*C6*/ 'image_part_020.png',
  /*C7*/ 'image_part_021.png',

  /*B1*/ 'image_part_008.png',
  /*B2*/ 'image_part_009.png',
  /*B3*/ 'image_part_010.png',
  /*B4*/ 'image_part_011.png',
  /*B5*/ 'image_part_012.png',
  /*B6*/ 'image_part_013.png',
  /*B7*/ 'image_part_014.png',

  /*A1*/ 'image_part_001.png',
  /*A2*/ 'image_part_002.png',
  /*A3*/ 'image_part_003.png',
  /*A4*/ 'image_part_004.png',
  /*A5*/ 'image_part_005.png',
  /*A6*/ 'image_part_006.png',
  /*A7*/ 'image_part_007.png'
];
